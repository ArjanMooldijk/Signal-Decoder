...
// Version 1.1 (02-05-20)  Arjan Mooldijk
...
enum {
   VorAdr1F    , // Vorsignal addr 1,  Fade    Voorsignaal, eerste adres  beelden Vr0 & Vr1
   VorAdr2F    , // Vorsignal addr 2,  Fade    Voorsignaal, tweede adres  beelden Vr2 & donker
   VorAdr1nF   , // Vorsignal addr 1,  no Fade Voorsignaal, eerste adres  beelden Vr0 & Vr1
   VorAdr2nF   , // Vorsignal addr 2,  no Fade Voorsignaal, tweede adres  beelden Vr2 & donker
//
   RangAdr1F   , // Rangier addr 1,    Fade    Rangeersignaal, eerste adres  beelden Sh0 & Sh1
   RangAdr1nF  , // Rangier addr 1,    no Fade Rangeersignaal, eerste adres  beelden Sh0 & Sh1
//
   HauptAdr1F  , // Haupt addr 1,      Fade    Hoofdsignaal eerste adres beelden Hp0 & Hp1
   HauptAdr2F  , // Haupt addr 2,      Fade    Hoofdsignaal tweede adres beeld Hp2
   AusfAdr1F   , // Ausfahr addr,      Fade    Ausfahr signaal eerste adres beeld Hp0 & Hp1
   AusfAdr2F   , // Ausfahr addr,      Fade    Ausfahr signaal tweede adres beeld Hp2 & Hp0/Sh1
   HauptAdr1nF , // Haupt addr 1,      no Fade    Hoofdsignaal eerste adres beelden Hp0 & Hp1 
   HauptAdr2nF , // Haupt addr 2,      no Fade    Hoofdsignaal tweede adres beeld Hp2
   AusfAdr1nF  , // Ausfahr addr,      no Fade    Ausfahr signaal eerste adres beeld Hp0 & Hp1
   AusfAdr2nF  , // Ausfahr addr,      no Fade    Ausfahr signaal tweede adres beeld Hp2 & Hp0/Sh1
};
