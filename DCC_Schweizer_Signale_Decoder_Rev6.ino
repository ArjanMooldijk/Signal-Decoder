...
// Version 2.6 (13-11-19)  Arjan Mooldijk
...
#define Vor1AdrF      2 // Vorsignal 1 addr,  Fade    Voorsignaal, één adres (2 pins)  beelden Warnung & Fb1
#define VorAdr2F      3 // Vorsignal addr 2,  Fade    Voorsignaal, tweede adres  beelden Fb2 & Fb3
#define VorAdr3F      4 // Vorsignal addr 3,  Fade    Voorsignaal, derde adres  beeld Fb5
#define VorAdr2Dkl    5 // Vorsignal addr 2,  Fade    Voorsignaal, tweede adres donker schakelen
#define VorAdr1nF     6 // Vorsignal addr 1,  no Fade Voorsignaal, eerste adres  beelden Warnung & Fb1
#define Vor1AdrnF     7 // Vorsignal 1 addr,  no Fade Voorsignaal, één adres (2 pins)  beelden Warnung & Fb1
#define VorAdr2nF     8 // Vorsignal addr 2,  no Fade Voorsignaal, tweede adres  beelden Fb2 & Fb3
#define VorAdr3nF     9 // Vorsignal addr 3,  no Fade Voorsignaal, derde adres  beeld Fb5
//
#define ZwergAdr1F   10 // Zwerg addr 1,      Fade    Dwersignaal, eerste adres  beelden Halt & Fahrt
#define ZwergAdr2F   11 // Zwerg addr 2,      Fade    Dwersignaal, tweede adres  beeld Fahrt mit Vorsicht
#define ZwergAdr1nF  12 // Zwerg addr 1,      no Fade Dwersignaal, eerste adres  beelden Halt & Fahrt
#define ZwergAdr2nF  13 // Zwerg addr 2,      no Fade Dwersignaal, tweede adres  beeld Fahrt mit Vorsicht
//
#define SIMHaupt     14 // SIM Haupt,         SIM hoofdsein
#define SIMVor       15 // SIM Vor,           SIM voorsein
//
#define HauptAdr1F   16 // Haupt addr 1,      Fade    Hoofdsignaal eerste adres beelden Fb0 & Fb1
#define HptAdr2Fb2F  17 // Haupt addr 2,      Fade    Hoofdsignaal tweede adres beeld Fb2 (3-licht sein)
#define HptAdr2Fb3F  18 // Haupt addr 2,      Fade    Hoofdsignaal tweede adres beeld Fb3 (3-licht sein)
#define HauptAdr2F   19 // Haupt addr 2,      Fade    Hoofdsignaal tweede adres beeld Fb2 & Fb3 (4/5/6-licht sein)
#define HptAdr3Fb6F  20 // Haupt addr 3,      Fade    Hoofdsignaal derde adres beeld Fb6 (5-licht sein)
#define HauptAdr3F   21 // Haupt addr 3,      Fade    Hoofdsignaal derde adres beeld Fb5 & Fb6 (6-licht sein)
#define HauptAdr1nF  22 // Haupt addr 1,      no Fade Hoofdsignaal eerste adres beelden Fb0 & Fb1
#define HptAdr2Fb2nF 23 // Haupt addr 2,      no Fade Hoofdsignaal tweede adres beeld Fb2 (3-licht sein)
#define HptAdr2Fb3nF 24 // Haupt addr 2,      no Fade Hoofdsignaal tweede adres beeld Fb3 (3-licht sein)
#define HauptAdr2nF  25 // Haupt addr 2,      no Fade Hoofdsignaal tweede adres beeld Fb2 & Fb3 (4/5/6-licht sein)
#define HptAdr3Fb6nF 26 // Haupt addr 3,      no Fade Hoofdsignaal derde adres beeld Fb6 (5-licht sein)
#define HauptAdr3nF  27 // Haupt addr 3,      no Fade Hoofdsignaal derde adres beeld Fb5 & Fb6 (6-licht sein)
//
#define HbB          28 // HbB addr 1,         Halt bei Bedarf sein
