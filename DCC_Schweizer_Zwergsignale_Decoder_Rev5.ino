...
// Version 2.2 (02-05-20)  Arjan Mooldijk
...
enum {
  ZwergAdr1F    , // Zwerg addr 1,      Fade    3 leds Fade !!STARTPIN!!
  ZwergAdr2F    , // Zwerg addr 2,      Fade    3 leds Fade
  ZwergAdr1nF   , // Zwerg addr 1,      no Fade 3 leds !!STARTPIN!!
  ZwergAdr2nF   , // Zwerg addr 2,      no Fade 3 leds
};
